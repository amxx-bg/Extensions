...
class main_module
{
	...
	public function main($id, $mode)
	{
		...
		/** @var \evilsystem\forumextras\controller\ucp_controller $ucp_controller */
		$ucp_controller = $phpbb_container->get('evilsystem.forumextras.controller.ucp');
